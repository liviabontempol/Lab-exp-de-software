...
TOTAL_REPOS_PESQUISA = 200  # Centraliza o limite exigido pelo trabalho

# Nomes de Arquivos de Saída
ARQUIVO_CSV = "repositorios_populares_200_prs.csv"
ARQUIVO_JSON = "repositorios_populares_200_prs.json"
